		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
								<?php foreach($notis as $noti) { ?>
									<li style="background-color: <?= $noti->status == $noti::NOT_SEEN ? '#f3d8d8' : '#fff' ?>">
										<a href="<?= $noti->url ?>">
											<span class="time"><?= $noti::STATUS[$noti->status] ?></span>
													<span class="details">
				...
				<li class="dropdown dropdown-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle" src="<?= $model->user->getPictureUrl('avatar') ?>"/>
					...
					<ul class="dropdown-menu dropdown-menu-default">
						<li>
							<a href="<?= Url::to([
								...
								<i class="icon-user"></i> Cập nhật tài khoản </a>
						</li>
						<li class="divider">
						</li>
						<li>
