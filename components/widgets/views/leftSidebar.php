...
<!--<div id="mws-sidebar">-->
<!--	<!-- Searchbox -->-->
<!--	<div id="mws-searchbox" class="mws-inset" style="height: 30px">-->
<!--		-->
<!--	</div>-->
<!---->
...
//				[
//					'label'    => 'Dashboard',
//					'template' => '<a href="{url}" class="mws-i-24 i-home" style="">{label}</a>',
//					'url'      => ['site/index'],
//				],
//				[
//					'label'    => 'Transaction',
//					'url'      => '#',
//					'template' => '<a href="{url}" class="mws-i-24 i-price-tag" style="">{label}</a>',
//					'options'  => ['class' => ''],
//					'items'    => [
//						[
//							'label' => 'PH History',
//							'url'   => ['transaction/provide-help'],
//						],
//						[
//							'label' => 'GH History',
//							'url'   => ['transaction/get-help'],
//						],
//					],
//				],
//				[
//					'label'    => 'User',
//					'url'      => '#',
//					'template' => '<a href="{url}" class="mws-i-24 i-users" style="">{label}</a>',
//					'options'  => ['class' => ''],
//					'items'    => [
//						[
//							'label' => 'Level Up',
...
//				[
//					'label'    => 'Key',
//					'template' => '<a href="{url}" class="mws-i-24 i-creditcard" style="">{label}</a>',
//					'url'      => '#',
//					'options'  => ['class' => ''],
//					'items'    => [
//						[
...
//					'label'    => ' Account',
//					'url'      => '#',
//					'template' => '<a href="{url}" class="mws-i-24 mws-i-24 i-info-about" style="">{label}</a>',
//					'options'  => ['class' => ''],
//					'items'    => [
//						[
//							'label' => 'Profile',
...
//					'url'      => '#',
//					'options'  => ['class' => ''],
//					'template' => '<a href="{url}" class="mws-i-24 i-locked" style="">{label}</a>',
//					'items'    => [
//						[
...
//						],
//						[
//							'label' => 'Change Password 2',
//							'url'   => ['user/change-security-password'],
//						],
//					],
//				],
//				[
//					'label'    => 'Email',
//					'template' => '<a href="{url}" class="mws-i-24 i-inbox" style="">{label}</a>',
//					'url'      => '#',
//					'options'  => ['class' => ''],
//					'items'    => [
//					],
...
//			'submenuTemplate' => "\n<ul>\n{items}\n</ul>\n",
//			'options'         => array('class' => ''),
//			'linkTemplate'    => '<a href="{url}" style="">{label}</a>',
